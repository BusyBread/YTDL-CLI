<#
    ...
    Path to save downloaded files, if not already present the script will attempt to create the directory. Defalts folder to users Downloads.
...
#>
param(
    $YTDL_Executable = (Join-Path -Path $env:LOCALAPPDATA -ChildPath "someotherpath\youtube-dl.exe"),
